...
The owner asked what they can say here. Answer with exactly this list,
one plain line per verb — do not improvise additions:

- `catchup` — where was I: re-ground, tidy the state file, and report
...
Mostly for working agents (you rarely need these): `decision`, `plan`,
`playbook`.
